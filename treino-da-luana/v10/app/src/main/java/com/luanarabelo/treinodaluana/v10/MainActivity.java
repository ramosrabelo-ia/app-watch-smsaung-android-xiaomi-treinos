package com.luanarabelo.treinodaluana.v10;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences("treino_v10", MODE_PRIVATE);
        showHome();
    }
    ...
    private void showHome() {
        ...
        root.addView(createDailyHero(), full(dp(230)));
    ...
    private View createDailyHero() {
        FrameLayout hero = new FrameLayout(this);
        hero.setBackground(round(OBSIDIAN, 24, 0, 0));
        hero.setClipToOutline(true);

        int photoOfDay = (Calendar.getInstance().get(Calendar.DAY_OF_YEAR) - 1) % 4;
        ImageView image = new ImageView(this);
        image.setScaleType(ImageView.ScaleType.CENTER_CROP);
        image.setContentDescription("Foto da Luana no treino");
        image.setImageBitmap(loadAsset("heroes/hero_" + photoOfDay + ".jpg"));
        ...
        TextView dayChip = micro("CAPA DO DIA  " + (photoOfDay + 1) + "/4", WHITE);
        ...
        TextView subtitle = micro("V10  •  PREMIUM OBSIDIAN", CYAN);
    ...
    private View createWorkoutCard(int workout) {
        ...
        card.setOnClickListener(view -> showExercise(workout, firstIncompleteExercise(workout)));
    ...
    private void showExercise(int workout, int exercise) {
        ...
        finish.setOnClickListener(view -> {
            ...
            updateWorkoutCheckin(workout);
            if (exercise < 6) {
                showExercise(workout, exercise + 1);
            } else {
        ...
        previous.setOnClickListener(view -> showExercise(workout, exercise - 1));
        navigation.addView(previous, weightedWithRight(6));
        Button next = smallButton("PRÓXIMO", exercise < 6);
        next.setOnClickListener(view -> showExercise(workout, exercise + 1));
    ...
    private View createProgressRow(int workout) {
        ...
        row.setOnClickListener(view -> showExercise(workout, firstIncompleteExercise(workout)));
