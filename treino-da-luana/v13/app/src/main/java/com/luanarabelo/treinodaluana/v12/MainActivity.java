...
public class MainActivity extends Activity implements DataClient.OnDataChangedListener {
    ...
    private void showSyncSetup() {
        ...
        TextView footer = body(
                "O check do relógio atualiza o mesmo bloco no celular. Ao concluir o último abdominal, a sessão “Treino da Luana A, B, C ou D” é registrada no Health Connect.",
                12,
                MUTED
        );
    ...
    private void showPrivacyPolicy() {
        ...
        TextView title = heading("Como a V13 usa seus dados", 30);
        ...
        TextView text = body(
                "A V13 solicita apenas permissão para gravar no Health Connect uma sessão de treino de força concluída. O registro contém horário de início, horário de fim, letra do treino e grupo muscular.\n\n"
                        + "Os checks dos 24 blocos são sincronizados diretamente entre o aplicativo Android e o Galaxy Watch8 pelo Wear OS Data Layer. Eles ficam nos seus aparelhos e não passam por um servidor do Treino da Luana. Cargas continuam salvas somente no celular.\n\n"
