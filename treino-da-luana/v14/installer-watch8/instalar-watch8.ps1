...
$ApkName = "Treino-da-Luana-v14.1-Galaxy-Watch8-CORRIGIDO.apk"
$ExpectedSha256 = "1C75FFFA496CBE42CEF905E075DFC4DDB555AFA87E62B201AAE99DFD27266657"
...
function Show-Title {
    ...
    Write-Host "  TREINO DA LUANA V14.1 - INSTALADOR WATCH8" -ForegroundColor Cyan
    Write-Host "============================================================" -ForegroundColor DarkGray
    Write-Host ""
}
...
Write-Host ""
Write-Host "Pronto. Procure Treino da Luana V14.1 na lista de aplicativos do Watch8." -ForegroundColor Green
