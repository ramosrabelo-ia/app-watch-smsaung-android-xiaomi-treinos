...
const output = path.resolve(here, "../screenshots/phone-v13-home.png");
const svgOutput = path.resolve(here, "../screenshots/phone-v13-home.svg");
...
let svg = `<svg xmlns="http://www.w3.org/2000/svg" width="720" height="1600">
  ...
  ${txt(55, 300, "V13  •  SAMSUNG SYNC", 16, C.cyan, 800, "start", 1)}
  ${card(30, 335, 660, 145)}
...
svg += `${card(30, 1174, 660, 352, C.orange)}
  ...
  ${txt(56, 1253, "Checks e atividade em sintonia", 24, C.white, 900)}
  ...
  ${txt(56, 1295, "Marque no relógio ou no celular: o mesmo bloco", 16, C.muted, 500)}
  ${txt(56, 1320, "é atualizado nos dois aparelhos. A sessão concluída", 16, C.muted, 500)}
  ${txt(56, 1345, "segue ao Samsung Health pelo Health Connect.", 16, C.muted, 500)}
  ...
  ${txt(360, 1480, "V13  •  XIAOMI + GALAXY WATCH8", 14, C.muted, 700, "middle", 1)}
</svg>`;
