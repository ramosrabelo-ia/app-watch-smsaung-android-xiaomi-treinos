...
public class WorkoutReceiver extends BroadcastReceiver {
    public static final String ACTION_PREVIOUS = "com.luanarabelo.treinodaluana.v6.PREVIOUS";
    public static final String ACTION_NEXT = "com.luanarabelo.treinodaluana.v6.NEXT";
    public static final String ACTION_FINISH = "com.luanarabelo.treinodaluana.v6.FINISH";
