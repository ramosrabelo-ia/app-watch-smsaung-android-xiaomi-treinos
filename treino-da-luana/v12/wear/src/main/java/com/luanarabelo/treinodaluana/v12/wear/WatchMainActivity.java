...
public final class WatchMainActivity extends Activity {
    ...
    private void showHome() {
        ...
        root.addView(text("V12 // GALAXY WATCH8", 11, ORANGE, true));
        ...
        root.addView(text("XIAOMI + WEAR OS 6", 10, MUTED, true));
    ...
    private void showBlock(int selectedBlock) {
        ...
        check.setOnClickListener(v -> {
            preferences.edit().putBoolean(key(workout, block), !isDone(workout, block)).apply();
            showBlock(block);
        });
