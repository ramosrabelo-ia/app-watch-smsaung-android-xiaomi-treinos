...
public class WorkoutReceiver extends BroadcastReceiver {
    public static final String ACTION_PREVIOUS = "com.luanarabelo.treinodaluana.v11.PREVIOUS";
    public static final String ACTION_NEXT = "com.luanarabelo.treinodaluana.v11.NEXT";
    public static final String ACTION_FINISH = "com.luanarabelo.treinodaluana.v11.FINISH";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_FINISH.equals(intent.getAction())) {
            ...
            Toast.makeText(context, "Notificação do treino finalizada", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        NotificationHelper.showExercise(context, workout, exercise);
    }
}
