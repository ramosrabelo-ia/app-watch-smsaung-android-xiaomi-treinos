...
public class WorkoutReceiver extends BroadcastReceiver {
    public static final String ACTION_PREVIOUS = "com.luanarabelo.treinodaluana.PREVIOUS";
    public static final String ACTION_NEXT = "com.luanarabelo.treinodaluana.NEXT";
    public static final String ACTION_FINISH = "com.luanarabelo.treinodaluana.FINISH";
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            Diagnostics.saveCrash(context, t);
        }
    }
}
